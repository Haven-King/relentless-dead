package dev.hephaestus.relentlessdead.impl.entity.ai.control;
...
public class ZombieMoveControl extends MoveControl {
	public ZombieMoveControl(MobEntity entity) {
		super(entity);
	}

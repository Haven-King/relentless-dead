...
public abstract class PathNodeMaker {
   ...
   protected PathfindingEntity entity;
   ...
   protected PathNode getNode(int x, int y, int z) {
      return this.pathNodeCache.computeIfAbsent(PathNode.hash(x, y, z), (l) -> {
   ...
   public abstract PathNodeType getNodeType(BlockView world, int x, int y, int z, PathfindingEntity mob, int sizeX, int sizeY, int sizeZ, boolean canOpenDoors, boolean canEnterOpenDoors);
